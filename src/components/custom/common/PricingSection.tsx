    ...
    <>
      ...
      <Sheet open={isOpen} onOpenChange={setIsOpen}>
        ...
        >
          ...
          <div className="min-h-full flex items-center justify-center py-16 px-8">
            {/* Pricing Cards Grid - Now Properly Scrollable */}
            <div className="grid max-w-6xl w-full mx-auto gap-4 lg:grid-cols-3 auto-rows-max">
