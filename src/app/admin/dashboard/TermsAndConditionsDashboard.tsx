...
export default function TermsAndConditionsDashboard() {
  ...
  // Fetch terms and conditions with React Query
  const {
    data: termsResponse,
    isLoading,
    isError,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-orange-50/50 to-red-50/30 p-6">
      <div className="max-w-7xl mx-auto space-y-8">
        {/* Header */}
        <div className="text-center space-y-4 mb-12">
          <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-gradient-to-r from-orange-100 to-red-100 border border-orange-200/60 backdrop-blur-sm">
          ...
          <p className="text-xl text-slate-600 max-w-2xl mx-auto">
            Manage terms and conditions sections for your platform
          </p>
        </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-slate-600">
                    Total sections: {terms.length}
                  </p>
                </div>
              </div>
              <Button
                onClick={() => setCreateModal(true)}
                className="bg-gradient-to-r from-orange-500 to-red-600 hover:from-orange-600 hover:to-red-700 text-white rounded-xl px-6 py-2 shadow-lg"
              >
          ...
          {!isLoading && !isError && (
            <Table>
              <TableCaption className="p-6 text-slate-500">
                A list of all terms and conditions sections.
              </TableCaption>
              <TableHeader>
                  ...
                  >
                    ...
                    <TableCell className="font-medium">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-slate-900">{term?.title}</span>
                      </div>
                    </TableCell>
                    <TableCell>
                      ...
                      <div className="space-y-1">
                        ...
                        {term?.items?.length > 2 && (
                          <p className="text-xs text-slate-400 italic">
                            +{term.items.length - 2} more items...
                          </p>
                        )}
                      </div>
                    </TableCell>
          ...
          {!isLoading && !isError && terms.length === 0 && (
            <div className="p-12 text-center">
              ...
              <p className="text-slate-600 mb-6">
                Get started by creating your first terms and conditions section
              </p>
              <Button
                onClick={() => setCreateModal(true)}
