...
export function PlanForm({
  ...
  // ✅ FIX: already uses functional setState — stable, no stale closure
  const updateLimit = useCallback(
    (index: number, field: keyof PricingLimit, value: string | number) => {
      setFormData((prev) => ({
        ...prev,
  ...
  return (
    <Card className="w-full max-w-4xl mx-auto">
      <CardHeader>
        <CardTitle>
          {initialData?.title ? "Edit Plan" : "Create New Plan"}
        </CardTitle>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {/* Plan Type — ✅ FIX: value uses || undefined, onValueChange guarded */}
            <div className="space-y-2">
              ...
              <div className="flex justify-start items-center gap-1">
                <Select
                  ...
                  onValueChange={(val) =>
                    val && setFormData((prev) => ({ ...prev, type: val }))
                  }
                >
                  ...
                  <SelectContent>
                    <SelectGroup>
                      ...
                      <SelectItem value="Event package">
                        Event Package
                      </SelectItem>
          ...
          <div className="flex items-center justify-between p-4 border rounded-lg bg-amber-50 border-amber-200">
            ...
            <Switch
              ...
              onCheckedChange={(v) =>
                setFormData((prev) => ({ ...prev, isPopular: v }))
              }
            />
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              {formData.limits.map((limit, index) => (
                ...
                >
                  {/* ✅ FIX: value uses || undefined, onValueChange guarded */}
                  <Select
                    value={limit.key || undefined}
                    onValueChange={(val) =>
                      val && updateLimit(index, "key", val)
                    }
                  >
          ...
          <div className="flex justify-end gap-3">
            ...
            <Button disabled={isPending} type="submit">
              ...
              {initialData?.title ? "Update Plan" : "Create Plan"}
            </Button>
          </div>
        </form>
      </CardContent>
